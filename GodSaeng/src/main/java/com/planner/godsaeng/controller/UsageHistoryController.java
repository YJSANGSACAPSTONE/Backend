...
public class UsageHistoryController {
	...
	@RequestMapping("/save")
	public ResponseEntity<Boolean> search(@AuthenticationPrincipal JwtAuthentication user, @RequestBody UsageHistorySaveDTO uh) {
	...
	public ResponseEntity<List<UsageHistoryDTO>> search(@AuthenticationPrincipal JwtAuthentication user, @RequestParam("uid") String uid){
