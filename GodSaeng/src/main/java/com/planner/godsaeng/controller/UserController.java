...
import com.planner.godsaeng.security.oauth.dto.OAuth2UserInfo;
...
//   }
   ...
   @PostMapping("/adduser")
   public ResponseEntity addUser(@RequestBody SaveResponseDTO userinfo, @AuthenticationPrincipal JwtAuthentication user) {
